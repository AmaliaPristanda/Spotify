#credits: https://github.com/moritzmhmk/wsgi-cors-middleware?fbclid=IwAR2gNVqysYnCDYyD-Wh6kFIQuMgkphGvVwh9PfSg0f01KNqiZUO9juNgk60
...
class CorsMiddleware(object):
    ...
    def __init__(
        ...
        if credentials:  # do not include header if false
            self.cors_headers.append(('Access-Control-Allow-Credentials','true'))
